# FastAPI REST API / Microservice (Python 3.6)
...
[`testable-platform/Golden_Repo_Lite`](https://github.com/testable-platform/Golden_Repo_Lite/tree/python/Python_3.6).
...
Python 3.6, installs only production dependencies, runs as a non-root user, and
